...
[![Actions Status](https://github.com/New-Dev3/telegram-cli/workflows/telegram%20message/badge.svg)](https://github.com/New-Dev3/telegram-cli/actions)
  ...
  build:
    ...
    steps:
      - name: send telegram message on push
        uses: New-Dev3/telegram-cli@tele-cli
        with:
